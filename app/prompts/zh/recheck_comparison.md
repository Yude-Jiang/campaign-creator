...
3. **客观中立**：如实反映 {{ brief.name }} 的进步和不足——不要粉饰无变化或倒退的指标。
...
1. **排名变化**：本品牌的召回位置是否提升？从第几位提到第几位？
2. **提及质量**：本品牌被提及时的语境是否改善？（从"顺带一提"到"推荐方案"？）
3. **竞品变化**：新出现了哪些竞品？哪些竞品被弱化了？
4. **认知偏差修正**：之前的认知偏差是否得到纠正？
5. **关键词关联**：本品牌与目标关键词的关联是否增强？

### 变化评级

| 评级 | 标准 |
|------|------|
| **improved** | 本品牌的召回位置、提及质量或语境有明确改善 |
| **stable** | 无显著变化（排名、语境、竞品格局大致相同） |
| **declined** | 本品牌的认知变差（排名下降、被新竞品替代、出现负面信息） |
