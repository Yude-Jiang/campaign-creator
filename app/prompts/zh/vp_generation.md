...
3. **差异化**：必须说明与竞品相比的独特优势。{% if data_assets %}如果已知竞品，必须指名对比。{% else %}无数据资产时，竞品对比只能停留在**架构与功能维度的定性判断**，不得给出任何参数、比例或性能数字。宁可写"集成度更高"，也不要写"BOM 减少 15%"。{% endif %}
